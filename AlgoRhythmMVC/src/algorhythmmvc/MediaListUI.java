...
public class MediaListUI implements TableModelListener
{
    ...
    {          
        ...
        //theMediaNameFrame.setLayout(new GridBagLayout());
        
        /*
        layoutConst = new GridBagConstraints();
            layoutConst.gridx = 0;
            layoutConst.gridy = 1;
            theMediaNameFrame.add(theMediaTablePanel, layoutConst);
            //theMediaNameFrame.add(theButtonPanel);
        */
        ...
        layoutConst = new GridBagConstraints();
            layoutConst.gridx = 0;
            layoutConst.gridy = 1;
            theMediaNameFrame.add(theButtonPanel, layoutConst);
*/
